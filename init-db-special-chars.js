...
// With special character handling for database passwords
...
// Function to safely get database configuration
function getDatabaseConfig() {
  // Default configuration
  const config = {
    database: process.env.DB_NAME || 'hipaa_compliance',
    username: process.env.DB_USER || 'hipaa_user',
...
async function initializeDatabase() {
  try {
    ...
    try {
      ...
      console.log('3. If your password contains special characters, enclose it in double quotes in the .env file');
      console.log('4. Try temporarily changing your database password to something without special characters');
      return;
    }
